...
import { mediaActions, mediaSelector, queryStreams } from "../mediaSlice"
import { appDispatch } from "../../../common/store"
import ConfirmModal from "../../../components/ConfirmModal"
import BadgeLink from "../../../components/BadgeLink"
import NewStreamsModal from "./NewStreamsModal"
...
export function Component() {
  ...
  function onCreate() {
    appDispatch(mediaActions.updateSlice({ newStreamsModalOpen: true }))
  }

  return (
    <Fragment>
      <Cards
        loading={asyncStatus["queryStreams"] === "pending" || medias === undefined}
      ...
      <ConfirmModal
        ...
        loading={asyncStatus["deleteStreamss"] === "pending"}
      >
